...
async function runMigration() {
  ...
  try {
    ...
    const sql = readFileSync('./alter-desenhos-profissionais-add-radiografia-id.sql', 'utf8');

    console.log('🚀 Executando migração...');
    await client.query(sql);

    console.log('✅ Migração executada com sucesso!');
    console.log('📊 Coluna "radiografia_id" adicionada na tabela "desenhos_profissionais".');
  } catch (error) {
